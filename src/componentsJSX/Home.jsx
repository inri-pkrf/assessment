            ...
            <div className='div-list'>
                <div className="photo-list-item" >
                    <div className="photo-list-content">
                        ...
                        <img src={process.env.PUBLIC_URL + '/images/logos-home/mivne.png'} className="photo-list-image-homepage" alt="Diagram" />
                    </div>
                </div>
                ...
                <div className="photo-list-item" >
                    <div className="photo-list-content">
                        ...
                        <img src={process.env.PUBLIC_URL + '/images/logos-home/diagramIcon.png'} className="photo-list-image-homepage" alt="Gallery" />
                    </div>
                </div>
                ...
                <div className="photo-list-item" >
                    <div className="photo-list-content">
                        ...
                        <img src={process.env.PUBLIC_URL + '/images/logos-home/mimshak.png'} className="photo-list-image-homepage" alt="Relations" />
                    </div>
                </div>
                ...
                <div className="photo-list-item" >
                    <div className="photo-list-content">
                        ...
                        <img src={process.env.PUBLIC_URL + '/images/logos-home/icon-des.png'} id='icon-des' className="photo-list-image-homepage" alt="Relations" />
                    </div>
                </div>
                ...
                <div className="photo-list-item" >
                    <div className="photo-list-content">
                        ...
                        <img src={process.env.PUBLIC_URL + '/images/logos-home/ogenIcon.png'} className="photo-list-image-homepage" alt="Ogen" />
                    </div>
                </div>
            </div>
