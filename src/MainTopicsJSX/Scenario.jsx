...
function Scenario() {
  const images = [
    { src: '/assets/images/logos-ogen/ogen1.png', title: 'מים', text: 'הפסקה בהספקת המים למשך מספר ימים ' },
    ...
    { src: '/assets/images/logos-ogen/ogen8.png', title: 'עובדים זרים', text: '75%-90% מהעובדים יעזבו את עבודתם' },
    { src: '/assets/images/logos-ogen/ogen9.png', title: 'עובדים', text: 'ירידה של 40% בהגעת העובדים למקומות עבודה    ' },
    { src: '/assets/images/logos-ogen/ogen10.png', title: 'היסעים', text: 'ירידה של 30%-50% בזמינות שירותי התחבורה הציבורית' },
    { src: '/assets/images/logos-ogen/ogen11.png', title: '  דלק ', text: 'שיבושים קלים' },
    { src: '/assets/images/logos-ogen/ogen12.png', title: 'גפ"מ ', text: 'שיבושים במועדי ההספקה ' },
  ];
